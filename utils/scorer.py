...
def score(key, prediction, verbose=False):
    ...
    if verbose:
        print("Final Score:")
    prec_micro = 1.0
    print(no_re, 'Guess as no relation')
    print(sum(guessed_by_relation.values()), 'guess')
    print(sum(correct_by_relation.values()), 'correct')
    print(sum(gold_by_relation.values()), 'gold')
    ...
    print('If they are all the same, meaning')
    print('0 for Gold = No, Guess = Re')
    print('0 for Gold = Re, Guess = No')
    print('or the two has same number')
    print('precision = correct number/guessed number')
    print('recall = correct number/gold number')
